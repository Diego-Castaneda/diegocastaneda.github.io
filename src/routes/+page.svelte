<script>	
	import socrates_quote from '$lib/images/socrates-test.webp';
	...
	{#each posts as post (post.title) }
		<Card>
			<div class="image" slot="image">
				<Image src={socrates_quote} alt="quote by socrates"></Image>
			</div>
			<span slot="title">{post.title}</span>
			<span slot="readtime">{post.readtimeMinutes}</span>
